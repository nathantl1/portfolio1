...
export default function Hero() {
  return (
    <section id="home" className="min-h-screen pt-20 flex items-center justify-center bg-linear-to-br from-gray-50 to-brand-primary/5">
      <div className="container mx-auto px-6 text-center max-w-4xl">
        <h1 className="text-4xl md:text-6xl font-extrabold text-brand-secondary mb-6 leading-tight">
          Olá, eu sou{' '}
          {/* Atualizado para a nova sintaxe de gradiente de texto do v4 */}
          <span className="bg-linear-to-r from-brand-primary to-cyan-500 bg-clip-text text-transparent">
            {profile.name}
          </span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a 
            href="#contato"
            className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-brand-primary text-white font-semibold rounded-lg hover:opacity-90 transition-colors focus:ring-4 focus:ring-brand-primary/20"
          >
            <Mail size={18} />
            Entre em Contato
          </a>
